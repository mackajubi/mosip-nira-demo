...
;(function (factory) {
  ...
  $sk.fn.extend({
    ...
    setup: function() 
    {
      ...
      this.skitter_box.find('.label_skitter > h1').hide();
      this.skitter_box.find('.label_skitter > p').hide();
    ...
    start: function()
    {
      ...
      if (this.settings.label) this.skitter_box.find('.label_skitter > h1').delay(90).show();
      if (this.settings.label) this.skitter_box.find('.label_skitter > p').delay(100).show();
